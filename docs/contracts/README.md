...
| PredictionMarket *(implementation; markets are clones)* | Nurachain 1020 | `0x4b94c8F32Ff506D31d79d21D94eC1d8AE3d1F145` |
| PredictionPool *(implementation; pools are clones)* | Nurachain 1020 | `0x675b24758B199c3A5674f0288dfdeaA217fB2A86` |
| PredictionTreasury | Nurachain 1020 | `0xDABEDD148F5AE5f3e130aB811a8975828Ea75AA8` |
| NuraProfileProxy *(the profile registry — use the `NuraProfile` ABI)* | Nurachain 1020 | `0x8CFbcEf737BE3C67A52A20Ae3DCC685ACF759460` |
| NuraProfile *(implementation 1.0.0 behind the proxy)* | Nurachain 1020 | `0x8ff69542387343fe8a9e053779f23058fBbA7f71` |
...
- No proxy upgrades except the profile registry: `NuraProfile` is UUPS behind an ERC-1967
  proxy, upgradeable only by its two-step owner, with no admin path to user content (see
  [NuraProfile.md](NuraProfile.md)). Everything else has its behaviour fixed at deployment
  (the vault README calls this out as deliberate for CollateralizedNFT).
