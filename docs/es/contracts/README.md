...
| `BridgeUSDT` / `BridgeBNB` / `BridgeETH` / `BridgeBTC` | token/*.sol | tokens puente (18 decimales) |
...
| PredictionMarket (implementación; los mercados son clones) | Nurachain 1020 | 0x5b24628a7bB7d9c7c091650A1737ab94Cc9496b3 |
| PredictionPool (implementación; los pools son clones) | Nurachain 1020 | 0x18e35954D826565AD7E1d0bB95c743c883fB9aaf |
