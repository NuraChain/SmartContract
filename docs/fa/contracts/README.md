...
| [WNURA.md](WNURA.md) | ‏`WNURA` | token/WNURA.sol | wrapped-native |
| [MockToken.md](MockToken.md) | ‏`MockToken` | mocks/MockToken.sol | توکن dev/test |
...
| کارخانهٔ Forecast | ADMIN_ROLE + مالک + امضاکننده‌های حل | ساخت بازار (کارمزد ≤ ۱۰٪)، cancel، تغییر خزانه‌ها؛ حل نیازمند حد نصاب N-از-M (مثلاً ۳ از ۵)؛ مالک می‌تواند مجموعه را عوض کند |
...
| PredictionMarket (پیاده‌سازی؛ بازارها کلون هستند) | Nurachain 1020 | ‏0x5b24628a7bB7d9c7c091650A1737ab94Cc9496b3 |
| PredictionPool (پیاده‌سازی؛ پول‌ها کلون هستند) | Nurachain 1020 | ‏0x18e35954D826565AD7E1d0bB95c743c883fB9aaf |
| PredictionTreasury | Nurachain 1020 | ‏0x785090fF1b50EaB9943284FF835eD67a9ea617Ba |
| NuraProfileProxy (رجیستری پروفایل — با ABI ‏`NuraProfile`) | Nurachain 1020 | ‏0x8CFbcEf737BE3C67A52A20Ae3DCC685ACF759460 |
| NuraProfile (پیاده‌سازی 1.0.0 پشت پراکسی) | Nurachain 1020 | ‏0x8ff69542387343fe8a9e053779f23058fBbA7f71 |
...
- به‌جز رجیستری پروفایل، هیچ‌جا پروکسی/ارتقاء وجود ندارد: ‏`NuraProfile` پشت پراکسی ERC-1967 و
  از نوع UUPS است، فقط مالکِ دو مرحله‌ای می‌تواند ارتقا دهد و ادمین هیچ مسیری به محتوای کاربران
  ندارد (ببینید [NuraProfile.md](NuraProfile.md)). رفتار بقیهٔ قراردادها هنگام دیپلوی قطعی می‌شود.
