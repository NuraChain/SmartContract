...
| --- | --- |
| نام قرارداد | `WNURA` |
| فایل سولیدیتی | `contracts/token/WNURA.sol` |
...
نام داده تا کیف پول‌ها «WNURA» نشان دهند. دیپلوی canonical روی زنجیره از جابه‌جایی‌های این
فایل در مخزن قدیمی‌تر است و از آنها بی‌تأثیر. توجه: برخلاف WETH9 اصلی، fallback قابل‌پرداخت در این نسخه
