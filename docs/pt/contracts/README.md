...
| `WNURA` | token/WNURA.sol | nativo embrulhado (WETH9) |
| `MockToken` | mocks/MockToken.sol | token de teste |
...
| Fábrica Forecast | ADMIN_ROLE | criar mercados (taxa ≤ 10%), resolver/cancelar todos, redirecionar tesourarias |
...
| PredictionMarket (implementação; os mercados são clones) | Nurachain 1020 | 0x5b24628a7bB7d9c7c091650A1737ab94Cc9496b3 |
| PredictionPool (implementação; os pools são clones) | Nurachain 1020 | 0x18e35954D826565AD7E1d0bB95c743c883fB9aaf |
