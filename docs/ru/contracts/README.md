...
| Фабрика Forecast | ADMIN_ROLE | создание рынков (комиссия ≤ 10%), разрешение/отмена всех, перенаправление казначейств |
...
| PredictionMarket (реализация; рынки — клоны) | Nurachain 1020 | 0x5b24628a7bB7d9c7c091650A1737ab94Cc9496b3 |
| PredictionPool (реализация; пулы — клоны) | Nurachain 1020 | 0x18e35954D826565AD7E1d0bB95c743c883fB9aaf |
