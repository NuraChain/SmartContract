...
| `WNURA` | token/WNURA.sol | 原生币封装 (WETH9) |
| `MockToken` | mocks/MockToken.sol | 测试代币 |
...
| PredictionMarket（实现合约；市场为其克隆） | Nurachain 1020 | 0x5b24628a7bB7d9c7c091650A1737ab94Cc9496b3 |
| PredictionPool（实现合约；资金池为其克隆） | Nurachain 1020 | 0x18e35954D826565AD7E1d0bB95c743c883fB9aaf |
